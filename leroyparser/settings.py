...
LOG_ENABLED = True
LOG_LEVEL = 'DEBUG'
IMAGES_STORE = 'fotos' # !!!!! без этого фотки собираться не будут !!!!!!!
...
ITEM_PIPELINES = {
    ...
    'leroyparser.pipelines.LeryaPhotosPipline': 200
}
# тут приоритеты запуска пайплайнов
# чем выше цифра, тем выше приоритет (фотки делаем первее, нужно сначала скачать)
